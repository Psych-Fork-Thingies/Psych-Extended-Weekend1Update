...
import crowplexus.cne.hscript.Expr;
...
@:allow(crowplexus.cne.hscript.Checker)
class CheckerTypes {
	...
	function addXmlType(x:haxe.rtti.CType.TypeTree,todo:Array<Void->Void>) {
		...
		case TTypedecl(t):
			...
			if( t.path == "crowplexus.cne.hscript.TypeCheck" )
				td.params.reverse();
			todo.push(function() {
...
class Checker {
	...
	public static function typeStr( t : TType ) {
		...
		case TType(t, args):
			if( t.name == "crowplexus.cne.hscript.TypeCheck" )
				typeStr(args[1]);
			else
