...
class FlxVirtualPad extends FlxSpriteGroup {
	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode) {
		...
		switch (DPad){
			...
			case ALL:
				dPad.add(add(buttonUp = createMobileButton(0, FlxG.height - 85 * 3, "up", 0x00FF00)));
				dPad.add(add(buttonDown = createMobileButton(0, FlxG.height - 45 * 3, "down", 0x00FFFF)));
				dPad.add(add(buttonLeft = createMobileButton(42 * 3, FlxG.height - 85 * 3, "left", 0xFF00FF)));
				dPad.add(add(buttonRight = createMobileButton(42 * 3, FlxG.height - 45 * 3, "right", 0xFF0000)));
			case OptionsC:
			    dPad.add(add(buttonUp = createMobileButton(0, FlxG.height - 85 * 3, "up", 0x00FF00)));
				dPad.add(add(buttonDown = createMobileButton(0, FlxG.height - 45 * 3, "down", 0x00FFFF)));
		...
		switch (Action){
			...
			case ALL:
				...
				dPad.add(add(buttonCEUp = createMobileButton(FlxG.width - (44 + 42 * 4) * 3, FlxG.height - 85 * 3, "up", 0x00FF00)));
				dPad.add(add(buttonCEDown = createMobileButton(FlxG.width - (44 + 42 * 4) * 3, FlxG.height - 45 * 3, "down", 0x00FFFF)));
				dPad.add(add(buttonCEG = createMobileButton(FlxG.width - (44 + 42 * 1) * 3, 25, "g", 0x00FF00)));
	...
	{
	    if (ClientPrefs.data.virtualpadType == 'Newest')
